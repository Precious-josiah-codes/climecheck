...
const Sidebar = ({ openAddDeviceModal }) => {
  return (
    <aside
      id="default-sidebar"
      class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-primaryColor"
      aria-label="Sidebar"
    >
      <div class="h-full px-3 py-4 overflow-y-auto border-r border-gray-500 flex flex-col justify-between relative">
        {/* logo */}
        <div className="">
          {" "}
          <li>
        ...
        <ul class="space-y-2 text-[15.9px]">
          ...
          {/* add devices */}
          <li onClick={() => openAddDeviceModal(true)}>
            <a
              href="#"
